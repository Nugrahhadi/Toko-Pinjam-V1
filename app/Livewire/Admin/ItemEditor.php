    ...
    public function mount(?string $itemId = null): void
{
    ...
    protected function rules(): array
    {
        return [
            ...
            'slug'           => ['nullable','string','max:255', Rule::unique('items','slug')->ignore($this->item?->id)],
    ...
    public function save()
    {
        ...
        $images = array_values(array_filter(array_merge($this->existing_images, $uploadedPaths)));

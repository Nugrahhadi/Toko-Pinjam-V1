...
<div>
    ...
    @if (session()->has('message'))
        <div id="flash-message" class="mb-6 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg flex items-center transition-opacity duration-500">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    @else
                                        <div class="w-8 h-8 bg-gradient-to-r from-gray-400 to-gray-600 rounded-full flex items-center justify-center text-white text-sm font-medium">
                                            ?
                                        </div>
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-gray-900">{{ $post->author ?? 'Unknown' }}</div>
                                            <div class="text-sm text-gray-500">{{ $post->author_email ?? 'No email' }}</div>
                                        </div>
                                    @endif
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <button wire:click="confirmDelete({{ $post->id }})"
                                            ...
                                            title="{{ $post->status === 'draft' ? 'Tolak' : 'Hapus' }}">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

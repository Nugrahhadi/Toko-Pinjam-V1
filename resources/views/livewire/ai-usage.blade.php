                ...
                <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-700 text-justify relative">
                    ...
                    <div class="space-y-4 text-base md:text-lg leading-relaxed">
                      ...
                      <p>
                        ...
                        <a href="{{ route('super-team') }}" class="text-[#413291] font-semibold underline hover:text-[#332066]"><em>the Super Team</em></a> 
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <h3 class="text-5xl font-extrabold text-[#413291] mb-4" style="font-family: 'Google Sans', 'Product Sans', sans-serif;">
                            ...
                            <em>the Super Team?</em>
                        </h3>

                        <p class="text-gray-700 text-md mb-6">
                            Kami selalu membuka kesempatan untuk siapapun yang tertarik bergabung bersama <em>the Super Team</em>. <br>Daftarkan dirimu sekarang!
                        </p>

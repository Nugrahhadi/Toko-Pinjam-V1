  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-10">
      ...
      <p class="text-gray-700">
        Berdasarkan riset kami, 100 persen orang mengatakan pernah berada di situasi seperti ini dan menyambut baik jika ada opsi meminjam dengan harga murah. 
        <span class="font-bold">Toko Pinjam hadir untuk itu.</span>
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      ...
      <div class="bg-white rounded-lg shadow-md p-6 h-full relative">
        <div>
          ...
          <p class="text-gray-700 text-sm mb-20">
            Kalau beli sepatu seharga Rp 200 Ribu cuma untuk 4 kali pakai, itu artinya kamu keluar Rp 50.000 sekali pakai. <br>
            Di toko pinjam, cukup 10 Ribu saja! Kami menjamin harga termurah.
          </p>
        </div>
      ...
      <div class="bg-white rounded-lg shadow-md p-6 h-full relative">
        <div>
          ...
          <p class="text-gray-700 text-sm">
            Dengan meminjam, kita mengurangi produksi barang baru dan limbah dari barang yang jarang terpakai. Lebih sedikit konsumsi, lebih sedikit sampah.
          </p>
        </div>
      ...
      <div class="bg-white rounded-lg shadow-md p-6 h-full relative">
        <div>
          ...
          <p class="text-gray-700 text-sm">
            Gak perlu mikir soal penyimpanan, perawatan, atau barang nganggur di rumah. Pinjam saat butuh, kembalikan setelah pakai.
          </p>
        </div>

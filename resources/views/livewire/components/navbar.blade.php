        ...
        <div class="flex justify-between items-center h-16">
                        ...
                        <div class="absolute top-full left-0 mt-1 w-48 bg-white border border-gray-200 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                            <div class="py-1">
                                <a href="{{ route('chapter-purwokerto') }}"
                                   class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#FDF2EB] hover:text-[#433592] transition-colors"
                                   style="font-family: 'Google Sans', 'Product Sans', sans-serif;">
                                    <div class="flex items-center">
            ...
            <div class="hidden md:flex items-center space-x-4">
                <a href="{{ route('donasi') }}"
                   ...
                   style="font-family: 'Google Sans', 'Product Sans', sans-serif;"
                   title="Donasi untuk Toko Pinjam">
                ...
                @auth
                    ...
                    <div class="relative">
                        <button wire:click="toggleProfile"
                            ...
                            <svg class="w-4 h-4 transition-transform duration-200 {{ $profileOpen ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                      d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                            ...
                            <div class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg z-50">
                                <div class="py-1">
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <p class="text-sm text-gray-500" style="font-family: 'Google Sans', 'Product Sans', sans-serif;">
                                            {{ auth()->user()->email }}
                                        </p>
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit" class="flex items-center w-full px-4 py-2 text-red-600 hover:bg-red-50 hover:text-red-700 transition-colors" style="font-family: 'Google Sans', 'Product Sans', sans-serif;">
                                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"

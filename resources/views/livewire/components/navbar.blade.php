    ...
    <div class="px-4 py-2" style="background-color: #FFC131; color: #433592;">
        <div class="max-w-7xl mx-auto flex items-center justify-between text-sm">
            <div class="flex items-center">
                ...
                <span>Want to start your own Library of Things or power your own rental service with our platform?</span>
                <a href="#" class="ml-2 font-semibold underline">Find out more</a>
            </div>
            <div class="flex items-center">
                <div class="relative">
                    <input type="text" 
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="#" class="text-gray-700 font-medium" style="color: #433592;" onmouseover="this.style.color='#433592'" onmouseout="this.style.color='#6B7280'">The Things</a>
                    <a href="#" class="text-gray-700 font-medium" style="color: #433592;" onmouseover="this.style.color='#433592'" onmouseout="this.style.color='#6B7280'">Locations</a>
                    <div class="relative">
            ...
            <div class="hidden md:flex items-center space-x-4">
                ...
                @else
                    <a href="/login" class="text-gray-700 font-medium" style="color: #433592;" onmouseover="this.style.color='#433592'" onmouseout="this.style.color='#6B7280'">Sign In</a>

...
Route::middleware(["auth", "admin"])
    ...
    ->group(function () {
        ...
        Route::get("/blog", App\Livewire\Admin\BlogManagement::class)->name(
            "blog",
        );
        Route::get("/blog/create", App\Livewire\Admin\BlogEditor::class)->name(
            "blog.create",
        );
        Route::get(
            "/blog/{postId}/edit",
            App\Livewire\Admin\BlogEditor::class,
        )->name("blog.edit");

        // Items Management Routes
        Route::get("/items", App\Livewire\Admin\ItemManagement::class)->name(
            "items",
        );
        Route::get("/items/create", App\Livewire\Admin\ItemEditor::class)->name(
            "items.create",
        );
        Route::get(
            "/items/{itemId}/edit",
            App\Livewire\Admin\ItemEditor::class,
        )->name("items.edit");
        Route::get(
            "/rentals/create",
            App\Livewire\Admin\RentalCreate::class,
        )->name("rentals.create");

        // User Management Routes
        Route::get("/users", App\Livewire\Admin\UserManagement::class)->name(
            "users",
        );
        Route::get("/users/create", App\Livewire\Admin\UserEditor::class)->name(
            "users.create",
        );
        Route::get(
            "/users/{userId}/edit",
            App\Livewire\Admin\UserEditor::class,
        )->name("users.edit");
    });
